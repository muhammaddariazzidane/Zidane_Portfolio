...
import tokoamelImg from "../public/img/tokoamel.png";
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link href="https://toko-amel.jodhykotambunan.repl.co" passHref>
            <a target="_blank">
              <button className="px-8 py-2 mt-4 mr-5 rounded-full bg-blue-500 text-white">Demo</button>
            </a>
          </Link>
          <Link href="#" passHref>
            <a target="_blank">
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4 ">
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              ...
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> Get waves
              </p>
              <p className="text-gray-700 py-2 flex items-center">
