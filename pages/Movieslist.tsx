...
import Movies from "../public/img/movieslist.png";
  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute text-white top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] z-10 p-2">
          <h1 className="py-2 text-4xl">Zidane Movies List</h1>
          <h2>Bootstrap 5.2</h2>
        </div>
      </div>
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <Link href="https://muhammaddariazzidane.github.io/zidaneMovie/" passHref>
            <a target="_blank">
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> React-Bootstrap
              </p>
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> React JS
              </p>
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> Axios
              </p>
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> TMDB API
              </p>
              <p className="text-gray-700 py-2 flex items-center">
                <BsGearWideConnected className="pr-1 mr-2" /> Github Pages
              </p>
            </div>
          </div>
        </div>
